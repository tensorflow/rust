...
cmd="bindgen ${bindgen_options_c_api} ${include_dir}/tensorflow/c/c_api_experimental.h --output src/c_api.rs --  -I ${include_dir}"
echo ${cmd}
${cmd}
...
cmd="bindgen ${bindgen_options_runtime_functions} ${include_dir}/tensorflow/c/c_api_experimental.h --output src/runtime_linking/c_api.rs --  -I ${include_dir}"
echo ${cmd}
${cmd}
