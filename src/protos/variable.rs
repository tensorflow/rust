...
impl VariableDef {
    ...
    pub fn get_save_slice_info_def(&self) -> &SaveSliceInfoDef {
        self.save_slice_info_def
            .as_ref()
            .unwrap_or_else(|| <SaveSliceInfoDef as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for VariableDef {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<VariableSynchronization>,
            >(
                "synchronization",
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                _,
                ::protobuf::types::ProtobufTypeEnum<VariableAggregation>,
            >(
                "aggregation",
...
impl ::protobuf::ProtobufEnum for VariableSynchronization {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<VariableSynchronization> {
        match value {
            0 => {
                ::std::option::Option::Some(VariableSynchronization::VARIABLE_SYNCHRONIZATION_AUTO)
            }
            1 => {
                ::std::option::Option::Some(VariableSynchronization::VARIABLE_SYNCHRONIZATION_NONE)
            }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<VariableSynchronization>(
...
impl ::protobuf::ProtobufEnum for VariableAggregation {
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> =
            ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<VariableAggregation>(
                "VariableAggregation",
                file_descriptor_proto(),
            )
        })
