...
impl GraphDef {
    ...
    pub fn get_versions(&self) -> &super::versions::VersionDef {
        self.versions
            .as_ref()
            .unwrap_or_else(|| super::versions::VersionDef::default_instance())
    }
    ...
    pub fn get_library(&self) -> &super::function::FunctionDefLibrary {
        self.library
            .as_ref()
            .unwrap_or_else(|| super::function::FunctionDefLibrary::default_instance())
    }
...
impl ::protobuf::Message for GraphDef {
    ...
    fn default_instance() -> &'static GraphDef {
        ...
        unsafe { instance.get(GraphDef::new) }
    }
}
