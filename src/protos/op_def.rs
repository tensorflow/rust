...
impl OpDef {
    ...
    pub fn get_deprecation(&self) -> &OpDeprecation {
        self.deprecation
            .as_ref()
            .unwrap_or_else(|| <OpDeprecation as ::protobuf::Message>::default_instance())
    }
...
impl OpDef_AttrDef {
    ...
    pub fn get_default_value(&self) -> &super::attr_value::AttrValue {
        self.default_value.as_ref().unwrap_or_else(|| {
            <super::attr_value::AttrValue as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn get_allowed_values(&self) -> &super::attr_value::AttrValue {
        self.allowed_values.as_ref().unwrap_or_else(|| {
            <super::attr_value::AttrValue as ::protobuf::Message>::default_instance()
        })
    }
