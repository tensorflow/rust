...
impl TrackableObjectGraph {
    ...
    pub fn set_nodes(
        &mut self,
        v: ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject>,
    ) {
        self.nodes = v;
    }
    ...
    pub fn mut_nodes(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject> {
        &mut self.nodes
    }
    ...
    pub fn take_nodes(
        &mut self,
    ) -> ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject> {
...
impl ::protobuf::Message for TrackableObjectGraph {
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ::protobuf::reflect::accessor::make_repeated_field_accessor::<
                    _,
                    ::protobuf::types::ProtobufTypeMessage<TrackableObjectGraph_TrackableObject>,
                >(
                    "nodes",
    ...
    fn default_instance() -> &'static TrackableObjectGraph {
        static instance: ::protobuf::rt::LazyV2<TrackableObjectGraph> =
            ::protobuf::rt::LazyV2::INIT;
...
pub struct TrackableObjectGraph_TrackableObject {
    ...
    pub attributes:
        ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_SerializedTensor>,
    pub slot_variables:
        ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_SlotVariableReference>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl TrackableObjectGraph_TrackableObject {
    ...
    pub fn set_children(
        &mut self,
        v: ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_ObjectReference>,
    ) {
        self.children = v;
    }
    ...
    pub fn mut_children(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_ObjectReference> {
        &mut self.children
    }
    ...
    pub fn take_children(
        &mut self,
    ) -> ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_ObjectReference> {
    ...
    pub fn set_attributes(
        &mut self,
        v: ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_SerializedTensor>,
    ) {
        self.attributes = v;
    }

    // Mutable pointer to the field.
    pub fn mut_attributes(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_SerializedTensor> {
        &mut self.attributes
    }
    ...
    pub fn set_slot_variables(
        &mut self,
        v: ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_SlotVariableReference>,
    ) {
    ...
    pub fn mut_slot_variables(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<TrackableObjectGraph_TrackableObject_SlotVariableReference>
    {
...
impl ::protobuf::Message for TrackableObjectGraph_TrackableObject {
    ...
    fn default_instance() -> &'static TrackableObjectGraph_TrackableObject {
        static instance: ::protobuf::rt::LazyV2<TrackableObjectGraph_TrackableObject> =
            ::protobuf::rt::LazyV2::INIT;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            >(
                ...
                |m: &mut TrackableObjectGraph_TrackableObject_SerializedTensor| {
                    &mut m.checkpoint_key
                },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                _,
...
impl<'a> ::std::default::Default
    for &'a TrackableObjectGraph_TrackableObject_SlotVariableReference
{
        ...
        descriptor.get(|| {
            ...
            >(
                ...
                |m: &TrackableObjectGraph_TrackableObject_SlotVariableReference| {
                    &m.original_variable_node_id
                },
                |m: &mut TrackableObjectGraph_TrackableObject_SlotVariableReference| {
                    &mut m.original_variable_node_id
                },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<
                _,
            ...
            >(
                ...
                |m: &TrackableObjectGraph_TrackableObject_SlotVariableReference| {
                    &m.slot_variable_node_id
                },
                |m: &mut TrackableObjectGraph_TrackableObject_SlotVariableReference| {
                    &mut m.slot_variable_node_id
                },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<
                TrackableObjectGraph_TrackableObject_SlotVariableReference,
...
impl ::protobuf::reflect::ProtobufValue
    for TrackableObjectGraph_TrackableObject_SlotVariableReference
{
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
